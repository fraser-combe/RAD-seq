...
#Set working directory for treemix files
getwd()
setwd("C:/radiotor/Treemix")
##Plot
png("Treemix.png",width=2400,height=2000,res = 300)
plot_tree("Treemix")
dev.off()
plot_resid("TreeMix", "pop_order")
plot_resid("Treemix","pop_order") #poporder is a text file with populations in the order you want them
dev.off()
poporder=c("MDN","MDS","WTN","WTS","OUT")
